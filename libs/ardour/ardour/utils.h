...
LIBARDOUR_API std::string bump_name_number(const std::string& s, bool forward=true);
LIBARDOUR_API std::string bump_name_abc(const std::string& s, bool forward=true);
